...
public:
    ...
    void runTest() override
    {
        ...
        testNumeratorSetterGetter();
        testDenominatorSetterGetter();
        testSubBeatsPerBeat();
        testTotalSubdivisions();
        testCurrentSubdivision44();
        testSubdivisionWrapsAcrossBars();
        testNegativeBeatWrapping();
        testSubdivisionIn78();
        testPaintOff();
        testPaintFirstBeatPlaying();
    }
...
private:
    ...
    void testNumeratorSetterGetter()
    {
    ...
    void testDenominatorSetterGetter()
    {
    ...
    void testTotalSubdivisions()
    {
        beginTest("Total subdivisions calculation");
        BeatBar bar;

        bar.setNumerator(4); bar.setDenominator(4);
        expect(bar.getTotalSubdivisions() == 4);

        bar.setNumerator(3); bar.setDenominator(4);
        expect(bar.getTotalSubdivisions() == 3);

        bar.setNumerator(7); bar.setDenominator(8);
        expect(bar.getTotalSubdivisions() == 14);

        bar.setNumerator(6); bar.setDenominator(8);
        expect(bar.getTotalSubdivisions() == 12);
    }

    void testCurrentSubdivision44()
    {
    ...
    void testSubdivisionWrapsAcrossBars()
    {
    ...
    void testPaintFirstBeatPlaying()
    {
